...
/* --- AGI select menu (TAPD custom dropdown) ---
   TAPD's AGI select is rendered outside the trigger's subtree. Its menu
   needs an opaque surface and an explicit stacking level to cover content
   underneath the priority dialog. */
html[data-tapd-theme="dark"] [class*="agi-select__select-menu"],
html[data-tapd-theme="dark"] [class*="agi-select__options"],
html[data-tapd-theme="dark"] [class*="custom-option-item-container"],
html[data-tapd-theme="dark"] [class*="colorful-select-option"] {
  background-color: var(--tapd-bg-elevated) !important;
  color: var(--tapd-text-primary) !important;
  border-color: var(--tapd-border) !important;
}
html[data-tapd-theme="dark"] [class*="agi-select__select-menu"] {
  ...
  box-shadow: 0 4px 16px var(--tapd-shadow) !important;
}
html[data-tapd-theme="dark"] [class*="colorful-select-option-text"] {
  background-color: transparent !important;
  color: var(--tapd-text-primary) !important;
}
html[data-tapd-theme="dark"] [class*="colorful-select-option"]:hover {
...
/* ========== TAPD table owner text ========== */
html[data-tapd-theme="dark"] .table__owner {
  color: var(--tapd-text-primary) !important;
}
